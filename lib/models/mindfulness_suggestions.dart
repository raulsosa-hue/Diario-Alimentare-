...
const Map<MindfulnessMoment, List<String>> kMindfulnessSuggestions = {
  ...
  MindfulnessMoment.afterMeal: [
    ...
    'Niente giudizi: nota solo cosa è cambiato dentro di te.',
    ...
    'Il cibo ha calmato qualcosa o riempito qualcosa?',
  ...
  MindfulnessMoment.beforeExercise: [
    ...
    'Scegli un\u2019intenzione semplice: "mi muovo per prendermi cura."',
  ...
  MindfulnessMoment.afterExercise: [
    'Fermati 10 secondi: cosa è cambiato nel corpo e nella testa?',
